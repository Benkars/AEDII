...
public class C4ex3 {
	public static void main(String[] args) {
		...
		System.out.println("Até " + quantidadeDePoluente1 + " multa de R$" + valor1);
		System.out.println("Acima de " + quantidadeDePoluente1 + " até " + quantidadeDePoluente2 + " multa de R$" + valor2);
